...
class JobSearchCarousel extends StatefulWidget {
  ...
  @override
  State<JobSearchCarousel> createState() => _JobSearchCarouselState();
}

class _JobSearchCarouselState extends State<JobSearchCarousel> {
  @override
