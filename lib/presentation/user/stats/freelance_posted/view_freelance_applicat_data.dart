...
class FreelanceApplicationList extends StatefulWidget {
  const FreelanceApplicationList({super.key, required this.jobId});
  final String jobId;

  @override
  State<FreelanceApplicationList> createState() =>
      _FreelanceApplicationListState();
}

class _FreelanceApplicationListState extends State<FreelanceApplicationList> {
  ...
  Future<List<ApplicantDataModel>?> getIdofUser(String id) async {
    ...
    debugPrint(applicantData![0].applicantUserId);
